// Package ocpbugs48050_test implements an HTTP server with
// fine-grained control over response headers, bypassing Go's HTTP
// sanitisation for testing scenarios with multiple
